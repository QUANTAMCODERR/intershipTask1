export default function QtyAmtPanel() {
  ...
  return (
    <>
      ...
      <div className="sm:hidden bg-white border-t border-gray-300 px-[0.5px] space-y-0.5">
        ...
        <div className="grid grid-cols-2 gap-[1px]">
          {rows.map((_, index) => (
            <div key={index} className="contents">
              <button className="bg-blue-900 text-white rounded-full py-0. text-[10px] font-semibold">
                0
              </button>
