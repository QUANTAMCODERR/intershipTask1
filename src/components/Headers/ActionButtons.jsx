...
//             <button
//               key={btn.label}
//               className={`${btn.style} text-white font-semibold px-6 md:px-3 py-2 border border-black rounded-xl shadow font-mono whitespace-nowrap`}
//             >
//               {btn.label || "--:--:--"}
//             </button>
//           ))}
